...
<body>
	...
	<div class="easyui-panel" style="width:100%;max-width:100%;padding:30px 60px;">
		...
		<div id="demoThisTears">
			...
			<input id="yid" value="${thisyear[0].yid}" type="hidden">
			
			<div style="margin-bottom:20px;margin-left: 2%;">
			
			<a href="javascript:void(0)" class="easyui-linkbutton"  onclick="creatyearplan(1)" style="width:100px">提交</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="javascript:void(0)" class="easyui-linkbutton"  onclick="creatyearplan(2)" style="width:100px">取消</a>
			</div>
		</form>
		</div>
