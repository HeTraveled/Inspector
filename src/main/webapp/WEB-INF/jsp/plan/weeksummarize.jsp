...
<body style="padding:20px; box-sizing: border-box;">
		...
		<c:forEach items="${week}" var="lwnn" varStatus="status">
			<div class="weekSummarize">
				<div class="contentLeft" style="font-size:14px">
				...
				<div class="contentRight" >
					...
					<ul class="monthItem">
						<li class="item">
							<div class="plan">
							<div class="text"  style="font-size:15px">&nbsp;&nbsp;&nbsp;&nbsp;${ status.index+1}&nbsp;.&nbsp;&nbsp;<font>计划内容&nbsp;:&nbsp;</font>
							${lwn.body}
							</div>
							<div class="text"  style="font-size:15px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<c:if test="${lwn.remarks!=null }"><font>进展情况&nbsp;:&nbsp;</font>&nbsp;${lwn.remarks }</c:if>
								</div>
							</div>
						</li>
					</ul>
