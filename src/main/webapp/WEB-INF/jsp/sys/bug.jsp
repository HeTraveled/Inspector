...
<div style="padding:4px 5px 0px 5px;">
		...
		<table id="List" style="height:auto;border:1px solid #ccc;">
			<thead>
				<tr>
					<th align="center" data-options="field:'createBy',width: 40" >反馈人</th>
					<th data-options="field:'body',width: 40" >问题描述</th>	
					<th data-options="field:'createTime',width: 30" >反馈时间</th>
				</tr>
			</thead>
		</table>
	</div>
