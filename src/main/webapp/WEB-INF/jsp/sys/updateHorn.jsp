...
<body>
	...
	<div class="easyui-panel" style="width:100%;max-width:100%;padding:30px 60px;">
		...
		<input type="hidden" value="${horn.id }" id="id">
		<div id="oldbody" style="display: none;">${horn.body }</div>
						<div style="margin-bottom:20px;">
				<input class="easyui-textbox"  id="title" value=${horn.title } iconWidth="28" style="width:500px;height:34px;padding:10px"  data-options="label:'标题：',required:true,missingMessage:'*必填项'">
			</div>
					<div style="margin-bottom:20px;">
			...
			<script type="text/plain" id="body" style="width:100%;height:400px;">
				...
				<div style="margin-bottom:20px;">
				<label>状态：</label>
				<input type="radio" name="state" value="1" ${horn.state==1 ?'checked':'' }>发布&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" name="state" value="0" ${horn.state==0 ?'checked':'' }>未发布
			</div>
			<div style="margin-bottom:20px;">
