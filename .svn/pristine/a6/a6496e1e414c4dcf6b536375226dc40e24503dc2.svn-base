...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>jsAndcss/ymnets.easyui/content/Site.css">
...
<br>
<br>
<!-- <font style="font-size:22px">请输入标题：</font>
	<div style="margin:20px 0;"></div>
	<div style="margin-bottom:20px">
			<input id="text" type="text" class="easyui-textbox" data-options="label:'',labelPosition:'top',prompt:'请输入标题...'" style="width:70%;height:48px">
		</div> -->
		<div class="easyui-panel"  style="width:900px;padding:30px 60px;">
<div style="margin-bottom:20px">
			<input id="text"  type="text" class="easyui-textbox"  labelPosition="top" data-options="prompt:'请输入标题'" style="width:35%;height:30px">
		</div>
<br>


	<div style="margin-bottom:20px">
			<select class="easyui-combobox" id="state" name="state"  labelPosition="top" style="width:12%;">
...
<!-- <table>
   ...
   <%-- <input type="hidden" value="<%=imgPath%>" id="addimgPath"/>
             <input type="hidden" id="addImg" value="${advertisement.image }"/>
             <img class="img-rounded" width="200" height="200" id="img" src="${advertisement.image }" />
            <input type="file"   id="uploadFile" name="file" style="width:100px;color: transparent;">
            --%>
     <input type="file"   id="uploadFile" name="file" style="width:100px;color: transparent;">
<br>
<button class="btn"  onclick="demo1()">发布</button>&nbsp;
<!-- <button class="btn" onclick="getContent()">获得内容</button>&nbsp; -->
</form>
<div>
    <h3 id="focush2"></h3>
