...
<body>
	...
	<div class="easyui-panel" style="width:100%;max-width:100%;padding:30px 60px;">
		<form id="frm" method="post">
				...
				<input class="easyui-textbox"  id="title" iconWidth="28" style="width:400px;height:34px;padding:10px"  data-options="label:'上部分：',required:true,missingMessage:'*必填项',validType:'length[1,10]'">
			</div>
					<div style="margin-bottom:20px;">
				<input class="easyui-textbox"  id="title2" iconWidth="28" style="width:400px;height:34px;padding:10px"  data-options="label:'下部分：',required:true,missingMessage:'*必填项',validType:'length[1,10]'">
			</div>
				<div style="margin-bottom:20px;">
				<label>状态：</label>
